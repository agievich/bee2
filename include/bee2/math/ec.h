...
/*!	\brief Расчет малых нечетных кратных
...
// }
	...
	size_t max_w;			/*!< максимальная ширина окна */
...
/*!	\brief Создание группы точек эллиптической кривой
	...
	случае.
	\remark Любой из указателей xbase, basey может быть нулевым. При нулевом 
...
#define ecMulA ecMul0
#define ecMulA_deep ecMul0_deep
