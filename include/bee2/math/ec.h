...
завсимости от типа кривой. В функцию ecCreate() должен передаваться 
...
/*!	\brief Малые нечетные кратные
	...
	\expect Описание ec корректно.
	\expect Точка a лежит на кривой.
	\deep{stack} ecSmul_deep(ec->f->n, ec->d, ec->deep).
	\remark Реализация интерфейса ec_smul_i.
*/
void ecSmul(
	word b[],			/*!< [out] малые кратные */
...
#define ecMulA ecMulNAF
#define ecMulA_deep ecMulNAF_deep
