...
Месяцы нумеруются от 1 (январь) до 12 (декабрь).
Дни месяца -- от 1 до 28, 29, 30 или 31.

\remark Даты, в которых y < 1583, считаются некорректными (григорианский
календарь был введен в 1582 году).

Тройка кодируется либо тремя беззнаковыми целыми либо 6 октетами по схеме YYMMDD.
В последнем случае каждый октет представляет один десятичный знак даты:
