...
1 Кодируемые данные разбиваются на блоки --- тройки октетов или 24-ки битов. 
  Каждая 24-ка рабивается на четыре 6-ки. Каждая 6-ка кодируется 1 символом 
  алфавита b64_symbols: 000000 --- символом 'A',...., 111111 -- символом '/'.
...
/*!	\brief Декодирование буфера памяти
	...
	\remark Для размещения декодированных данных достаточно 
	3 * strLen(src) / 4 октетов.
*/
void b64To(
