...
где inv0(w0,w1,w2) = (w0+1,w1,w2), inv012(w0,w1,w2) = (w0+1,w1+1,w2+1).
Bash-S^2 можно записать следующим образом:

Bash-S^2 = S3 L3 S3 L3 = S3 inv012 L3 inv0 S3 L3 = S1 L3 S0 L3,

где S-блоки S0 = inv0 S3 и S1 = S3 inv012 могут быть выражены через 
"andnot", не используя "ornot". S0 применяется на тактах  1, 3, ...., 
S1 -- на тактах 2, 4, .....
*******************************************************************************
*/
