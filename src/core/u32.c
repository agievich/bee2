...
\remark Вторая редакция [War03], дополнительные материалы:
...
Реализован алгоритм, представленнный в [And05] (Reverse an N-bit quantity
in parallel in 5 * lg(N) operations). Первоисточник:

[Fre83] Freed E. Binary Magic Numbers, Dr. Dobb's Journal, 1983,
...
Реализованы алгоритмы из [War03] (п.п. 5.1, 5.2).
*******************************************************************************
*/
...
Реализованы алгоритмы из [War03]: п. 7.2 (с. 112).
*******************************************************************************
*/
